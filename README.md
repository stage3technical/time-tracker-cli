...
Cross-platform command-line client for the BLVD Timesheet API (`time-tracker-api`). Single static Go binary for Windows and Linux/macOS.
...
- `tt timesheets` — list, get, week, lastweek, submit, reject, unlock, purge
